	...
	public static ArrayList<Doctor> doctorAvailableAppointments = new ArrayList<>();
	 public static void showDoctorMenu(){
	        ...
	        do {
	            ...
	            System.out.println("Welcome " + UIMenu.dotorlogged.getName());
	 ...
	 private static void showAddAvailableAppointmentsMenu(){
	        ...
	        do {
	            ...
	            if (response > 0 && response < 4){
	                ...
	                UIMenu.dotorlogged.addAvailableAppointment(date,time);
	                checkDoctorAvailableAppointments(UIMenu.dotorlogged);
